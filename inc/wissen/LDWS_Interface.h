...
File name: LDWS_Debug.h
Version: 1.0		Date: 2017-04-28		Author: Yanming Wang		ID: 1047930

Description:
	The functions in this file are defined to realize the process of LDWS.
	The following function types are included:
	+ LDWS_AllocModel(): malloc the memory for parameters.
	+ LDWS_Init(): Init the values for parameters.
	+ LDWS_Tracker():  The main realization of LDWS.
	+ LDWS_Finalization(): free the model in LDWS.
	+ LDWS_GetResult(): Get the LDWS result.
	+ LDWS_GetXYZofWorldfromImage(): Get the coord of 3D world (X,Y,Z) basd on the ground point (x,y).
	+ LDWS_FreeResult(): Free pLDWSOutput.
	+ LDWS_Get_RunFlag(): get Donnees->runFlag.
	+ LDWS_GetCarWidth(): get Donnees->carWidth.
	+ LDWS_GetLeftDeviation(): get Donnees->leftDeviation.
	+ LDWS_GetRightDeviation(): get Donnees->rightDeviation.
	+ LDWS_GetWarningTTC(): get Donnees->TTCWaring.
	+ LDWS_ChangeResultWtoN(): given the value of L_output_N.
	+ LDWS_GetxyofImagefromWorld(): Get the coord of image ground point (x,y) basd on the3D world (X,Y,Z) .
	+ LDWS_Getinit(): Get the Init LDWS detected zone.
	+ LDWS_Freeinit(): Free the Init LDWS detected zone.
	+ LDWS_GetVanishY(): get Donnees->Vh.
	+ LDWS_GetVanishY_N(): get vanishY line of narrow.
	+ LDWS_GetResult_N(): get the LDWS result on narrow.
	+ LDWS_Get_inter_Pamer_W(): get inter param on width camera.
	+ LDWS_Get_inter_Pamer_N(): get inter param on narrow camera.
	+ LDWS_GetVanishPointSet(): get the statistic vanish point on detected window.
